...
Pod::Spec.new do |s|
  s.name             = 'PandoraBox'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PandoraBox.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhangpeng/PandoraBox'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhangpeng' => 'zhangpeng.0304@aliyun.com' }
  s.source           = { :git => 'https://github.com/zhangpeng/PandoraBox.git', :tag => s.version.to_s }
